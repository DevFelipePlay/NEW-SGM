      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={8}>
          ...
          <Cards title={'Relação entre ativações e recargas'} subTitle={''} size={'100%'}>
            <BarChart width={smDown ? 250 : lgDown ? 500 : 700} height={250} data={data}>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            ...
            />
            <Typography variant='h5' sx={{ m: 2, color: 'var(--primary_color)' }}>
              MAXX
            </Typography>
            <Box sx={{ mb: 2 }}>
              <Typography sx={{ fontSize: '1.2rem' }}>6 GB</Typography>
              <Typography sx={{ fontSize: '1.2rem' }}>100 minutos para SMS</Typography>
              <Typography sx={{ fontSize: '1.2rem' }}>WhatsApp Grátis</Typography>
