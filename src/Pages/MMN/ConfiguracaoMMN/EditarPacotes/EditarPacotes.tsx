        ...
        <FormControl>
          ...
          >
            <FormControlLabel
              value="0"
              control={<Radio />}
              label="Editar pacotes já existentes"
            />
            <FormControlLabel
              value="1"
              control={<Radio />}
              label="Excluir pacotes"
            />
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="Acrescentar um novo pacote"
            />
          </RadioGroup>
        </FormControl>
      </Cards>
              ...
              {responsePacotes.map((item, index) => (
                <Grid item xs={12} sm={8} key={index}>
                  <Cards
                    title={item.nome}
                    subTitle={
                      "Edite os dados dos seus pacotes de licenciamento"
                    }
                    size={"100%"}
                  >
                    <>
                    ...
                    <Grid item xs={12} sm={8}>
                      ...
                      >
                        <Box>
                          ...
                          <Typography>Oferece acesso ao multinível</Typography>
                          <Typography>
                            {" "}
