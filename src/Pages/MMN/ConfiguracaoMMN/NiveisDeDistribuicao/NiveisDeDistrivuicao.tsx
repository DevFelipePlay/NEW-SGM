    ...
    <Box sx={{ width: '100%' }}>
      <Cards title={'Configure os níveis de distribuição'} subTitle={' '} size={'100%'}>
        <FormControl>
          ...
          >
            <FormControlLabel value='0' control={<Radio />} label='Níveis Ativação' />
            <FormControlLabel value='1' control={<Radio />} label='Níveis Recarga' />
            <FormControlLabel value='2' control={<Radio />} label='Níveis Licenciamento' />
            <FormControlLabel value='3' control={<Radio />} label='Níveis Venda de Chip' />
          </RadioGroup>
        </FormControl>
      </Cards>
