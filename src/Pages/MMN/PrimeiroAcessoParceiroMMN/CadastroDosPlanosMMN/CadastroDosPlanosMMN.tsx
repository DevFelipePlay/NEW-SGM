        ...
        {loading ? (
          ...
          <>
            <Typography variant="h6">
              Selecione os planos que deseja ter no seu módulo
            </Typography>
            <Grid
              container
              width={"100%"}
            ...
            >
              {responseData.map(
                (plano: IResPostPlayRecuperaPlanosPrimeiroAcesso, index) => (
                  <Grid item key={index}>
                    <Cards
                      title={plano.nomeplano}
                      subTitle={
                        "Escolha os planos que serão usados no multinível"
                      }
