...
export function CompraDePacotes() {
  ...
  const [responseVisualizaFaturaPacotes, setResponseVisualizaFaturaPacotes] =
    useState<IResPostPlayVisualizaFaturasPacotes[]>([]);
  ...
  async function handleValidateLicenciamento() {
    ...
    try {
      ...
      const data = await postPlayValidaLicenciamento(
        payloadValidaLicenciamento
      );
    ...
    try {
      ...
      const data = await postPlayVisualizaFaturasPacotes(
        payloadVisualizaFaturasPacotes
      );
              ...
              <>
                ...
                >
                        ...
                        {response.length !== 1 ? (
                          <Grid container width={"100%"}>
                            {response &&
                              response.map(
                                (
                                  i: IResPostPlayRecuperaPacotesLicenciamento,
                                  index
                                ) => (
                  ...
                  <Button
                    onClick={() =>
                      navigate(
                        `/${user?.companyref}/primeiro-acesso-multinivel-usuario/ativacao-linha`
                      )
                    }
                    variant="outlined"
                    sx={{ my: 2 }}
              ...
              >
                ...
                {responseVisualizaFaturaPacotes
                  ...
                  .map((item, index) => (
                    ...
                    >
                      <Cards
                        title={`Fatura de ${item.tipo} em Aberto`}
                        subTitle={""}
                        size={"90%"}
                      >
                        <Link
                ...
                >
                  ...
                  >
                    <Tooltip title={"Copiar"}>
                      <Box
                        onClick={() =>
                          copyToText(responseValidaLicenciamento.link_indicacao)
                        }
                        sx={{
                          cursor: "pointer",
                          display: "flex",
