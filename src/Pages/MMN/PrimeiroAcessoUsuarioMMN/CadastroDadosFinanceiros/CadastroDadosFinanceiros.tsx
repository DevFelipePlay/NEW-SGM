  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (user?.msisdnativo) {
        ...
        navigate(`${user?.companyref}/sem-linha-ativa`);
      }
    } catch (error: any) {
      errorToast(error);
    } finally {
        ...
        >
          ...
          {formData.type_pix === "email" && (
            <CustomTextField
              ...
              onChange={(e) => changeForm("chave_pix", e.target.value)}
              helperText={
                !validations.chave_pix ? "O email deve ser valido" : ""
              }
          ...
          {formData.type_pix === "cpf" && (
            <CustomTextField
              ...
              onChange={(e) =>
                changeForm("chave_pix", e.target.value.replace(/\D/g, ""))
              }
              required
            />
          )}
          ...
          <CustomTextField
            ...
            required
            helperText={!validations.cpf_titular_pix ? "CPF INVÁLIDO" : ""}
