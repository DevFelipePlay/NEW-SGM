...
import { IReqPostPlayCadastroGraduacoesMMN } from '../../../../api/CadastroGraduacoesMMN/IReqPostPlayCadastroGraduacoes';
import { postPlayCadastroGraduacoesMMN } from '../../../../api/CadastroGraduacoesMMN/postPlayCadastroGraduacoes';
...
export function CadastroGraduacoesMMN() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      navigate('/primeiro-acesso-multinivel/cadastro-pontos-por-modalidade');
    } catch (error) {
      errorToast;
    } finally {
      setLoading(false);
