...
export function Login() {
  ...
  const [responseColors, setResponseColors] = useState<IResPostPlayListarCorSistemaPorCompanyRef>();
          ...
          {lgDown ? (
            ...
            >
              ...
              >
                ...
                >
                  <Typography variant={smDown ? 'h5' : 'h4'} sx={{ color: '#c0c0c0' }}>
                    Login
                  </Typography>
                  <TextInput
                    icon={undefined}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Typography variant='h2' color={'var(--primary_color)'} fontWeight={'900'}>
                    {`Sistema ${
                      responseColors?.tradename ? responseColors.tradename : 'Play Móvel'
                    }`}
                  </Typography>
                </Stack>
              </Box>
