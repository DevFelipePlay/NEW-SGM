...
import { currencyFormatter, currencyMask, errorToast } from '../../../../../utils';
...
export function Saque() {
  ...
  const [responseCalculo, setResponseCalculo] = useState<IResPostPlayCalculoPorcentagemSaque>();
                  ...
                  <Box sx={styleSaque} component={'form'}>
                    {handleModalCalculo ? (
                      ...
                      >
                        ...
                        <Typography variant='h5' color={'var(--primary-color)'} sx={{ mb: 2 }}>
