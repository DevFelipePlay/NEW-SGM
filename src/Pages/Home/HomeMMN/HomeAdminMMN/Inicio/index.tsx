...
export default function Tab0() {
  return (
    <Grid container spacing={2}>
      <Grid item>
        <Cards title={'Escala de usuários novos'} subTitle={''} size={'100%'}>
        ...
        <Cards title={'Relação entre ativações e recargas'} subTitle={''} size={'100%'}>
        ...
        <Cards title={'Total de Usuários Ativos'} subTitle={'Usuários ativos'} size={'100%'}>
          <Typography variant='h4'>40.973 Pessoas ativas</Typography>
        </Cards>
      </Grid>
      <Grid item>
        <Cards title={'Divisão do total de lucro'} subTitle={''} size={'100%'}>
