...
export function AllRoutes() {
  return (
    <RouterRoutes>
      ...
      <Route path=":companyref">
        {/* <Route index element={<Navigate to="teste" replace />} /> */}
        ...
        <Route element={<SideBarRoutes />}>
          <Route element={<AuthGuard allowedRoles={[-1, 0, 1]} />}>
            ...
            <Route
              ...
              element={<CadastrarUsuarioHomeParceiro />}
            />
            <Route path="home-play" element={<HomePlay />} />
            <Route path="info-user-mmn" element={<InfoUserMMN />}>
              <Route
                path="dashboard-info-user-mmn"
                element={<DashBoardInfoUserMMN />}
              />
            </Route>
            <Route
              path="dashboard-relatorio-usuario-mmn/:cpf"
              element={<DashboardRelatorioUsuario />}
            />

            <Route path="solicitacoes-saque" element={<SolicitacoesSaque />} />
            <Route
              path="solicitacoes-premios"
              element={<SolicitacoesPremios />}
            />
            <Route
              path="solicitacoes-pacotes"
              element={<SolicitacoesPacotes />}
            />
          </Route>
          ...
          <Route
            path="adquirir-licenciamento-mmn"
            element={<AdquirirLicenciamento />}
          />
          <Route
        ...
        <Route element={<AuthGuard allowedRoles={[-1, 0, 1]} />}>
          <Route path="primeiro-acesso-multinivel-parceiro">
            <Route
              path="cadastro-de-pacotes-mmn"
              element={<CadastroDePacotesMMN />}
            />
            <Route
              path="cadastro-de-pacotes-de-chips-mmn"
              element={<CadastroDePacotesDeChip />}
            />
            <Route
              path="cadastro-dos-planos-mmn"
              element={<CadastroDosPlanosMMN />}
            />
            <Route
            ...
            />
            <Route
              path="cadastro-graduacoes"
              element={<CadastroGraduacoesMMN />}
            />
            <Route
            ...
            />
            <Route
              path="cadastro-valores-e-taxas"
              element={<CadastroValoresETaxasMMN />}
            />
            <Route
              path="cadastro-premiacoes"
              element={<CadastroPremiacoesMMN />}
            />
          </Route>
        </Route>
      </Route>
