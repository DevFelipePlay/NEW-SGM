            ...
            >
              <Stack spacing={2} sx={style}>
                ...
                <Alert sx={{ mb: 2, textAlign: 'center' }} severity='info'>
                  <AlertTitle>
                    Ao realizar a exclusão deste usuário, todas as informações serão excluídas
                  </AlertTitle>
                  Ao excluir dados do banco de dados, é importante ter cuidado e considerar as
                  consequências, pois a exclusão será permanente e irreversível. Recomenda-se fazer
